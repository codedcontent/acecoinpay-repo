...
const CVVNumber = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between md:items-center gap-1 md:gap-10 w-full">
      ...
      <div className="flex items-center justify-center w-full md:w-1/2 border-2 border-gray-200 rounded-md px-4 py-3 focus-within:ring-2 focus-within:ring-primary focus-within:outline-none">
        <input
          type="text"
